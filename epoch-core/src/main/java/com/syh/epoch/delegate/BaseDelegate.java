...
import com.syh.epoch.activity.EpochActivity;
...
public abstract class BaseDelegate extends Fragment implements ISupportFragment{
  ...
  public final EpochActivity getEpochActivity(){
    return (EpochActivity) _mActivity;
  }
  ...
  @Override public SupportFragmentDelegate getSupportDelegate() {
    return DELEGATE;
  }
  ...
  @Override public void enqueueAction(Runnable runnable) {
    DELEGATE.enqueueAction(runnable);
  }

  @Override public void onEnterAnimationEnd(@Nullable Bundle savedInstanceState) {
...
DELEGATE.onLazyInitView(savedInstanceState);
  ...
  @Override public void onSupportInvisible() {
DELEGATE.onSupportInvisible();
  }

  @Override public boolean isSupportVisible() {
...
DELEGATE.setFragmentAnimator(fragmentAnimator);
  ...
  @Override public void setFragmentResult(int resultCode, Bundle bundle) {
...
DELEGATE.onFragmentResult(requestCode,resultCode,data);
  ...
  @Override public void onNewBundle(Bundle args) {
DELEGATE.onNewBundle(args);
  }

  @Override public void putNewBundle(Bundle newBundle) {
